...
def get_args():
    ...
    parser.add_argument("--max-episode-len", type=int, default=1500, help="maximum episode length")
    ...
    parser.add_argument("--buffer-size", type=int, default=int(2e5), help="number of transitions can be stored in buffer")
